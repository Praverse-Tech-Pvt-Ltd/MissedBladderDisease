...
export const metadata: Metadata = {
  title: 'Pathophysiology in Women',
  description: 'Understanding the pathophysiology of IC/BPS in women — from urothelial damage to central sensitization.',
}
        ...
        <section className="bg-charcoal py-24">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <p className="font-body text-lg text-white/60 font-light leading-relaxed max-w-2xl">
              Interstitial Cystitis / Bladder Pain Syndrome is a multifactorial condition,
              disproportionately affecting women, involving urothelial dysfunction, neurogenic
              inflammation, mast cell activation, and central sensitization — a cascade that takes
              years to reverse without targeted intervention.
            </p>
          </div>
        </section>
